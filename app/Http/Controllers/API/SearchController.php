...
class SearchController extends ResponseController
{
    public function search_tryout(Request $request)
    {
    	...
    	if($search_team_name && $latitude == null && $latitude == 0 && $longitude == null && $longitude ==  0)
    	{
    ...
    public function search_player(Request $request)
    {
        ...
        if($gender && $latitude == null && $longitude == null && $age == null && $latitude == 0 && $longitude ==  0 )
        {
        ...
        elseif($age && $gender == null && $latitude == null && $longitude == null && $latitude == 0 && $longitude ==  0)
        {
        ...
        elseif($gender && $age && $latitude == 0 && $longitude ==  0)
        {
